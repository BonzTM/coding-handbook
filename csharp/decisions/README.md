...
- [framework-selection.md](framework-selection.md) - the default dependency and framework choices, and the bar a new package must clear. Use it before adding any third-party NuGet package.
