...
Compiling reference modules: planned, phase 2. Until they land, [templates/](templates/) holds the canonical scaffolding and the only exact version pins.
...
- `templates/` ([README.md](templates/README.md)) - committed copy-paste scaffolding (`global.json`, `Directory.Build.props`, `Directory.Packages.props`, `verify.ps1`, `Program.cs`, CI workflows, Dockerfile, project README/AGENTS/CODEOWNERS, ADR template) — the only home of exact version pins
