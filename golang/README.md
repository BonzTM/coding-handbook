...
- A complete worked example to copy: [reference/exampleservice/](reference/exampleservice/) (HTTP+Postgres), [reference/examplegrpc/](reference/examplegrpc/) (gRPC), or [reference/exampleworker/](reference/exampleworker/) (event-driven) — all `make verify`-green
